...
const jsForm = document.getElementById("js-toDoForm");
const toDoInput = jsForm.querySelector("input");
...
function paintPendingTask(task) {
    ...
    completeBtn.classList.add('square');
    completeBtn.innerHTML = `<i class="fa fa-square-o" aria-hidden="true"></i>`;
...
function paintFinishedTask(task) {
    ...
    backBtn.classList.add('square');
    backBtn.innerHTML = `<i class="fa fa-check-square-o" aria-hidden="true"></i>`;
